"""
F2 Evaluation - Expanding-Window Evaluation Setup
===================================================================
Build expanding-window train / validation / test splits for the F2
...
Inputs
------
- dataset_F2_L30.npz              : stacked examples (X, y, asset_id, date)
- dataset_F2_L30_id_to_stock.csv  : asset-ID → RIC mapping (optional)

Outputs
-------
- evaluation_config_F2_L30.pkl    : full config dict (windows, capacity plan, mapping)
- evaluation_windows_summary_F2_L30.csv : one-row-per-window summary table
"""
...
ID_TO_STOCK_CSV = "dataset_F2_L30_id_to_stock.csv"

OUT_PKL = "evaluation_config_F2_L30.pkl"
OUT_SUMMARY_CSV = "evaluation_windows_summary_F2_L30.csv"
...
# Model capacity budget (fixed ex-ante previously and held constant across all experiments)
...
# 1  Load data
# ============================================================
print("=== Expanding-window evaluation setup (F2, L=30) ===\n")
