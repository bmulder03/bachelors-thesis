"""
F2 Evaluation - Joint MTL Model
================================
Expanding-window evaluation of the joint multi-task learning model on
the full SPI universe using feature block F2 (multivariate, L=30, F=10).

This is the multi-feature generalisation of the F1 evaluation script.
The trunk input projection is nn.Linear(F, d_model) and the feature
dimension F is auto-detected from the dataset, so the same code also
works for F1 (F=1) and F3.  Everything else — balanced sampling, strict
per-window reinitialisation, metrics, saving — is identical.

Inputs
------
- evaluation_config_F2_L30.pkl : window definitions (train/val/test indices)
- dataset_F2_L30.npz          : feature matrix X (N,L,F), targets y, asset IDs

Outputs
-------
- joint_mtl_F2_L30/joint_mtl_window_metrics.csv : per-window MSE summary
- joint_mtl_F2_L30/joint_mtl_preds_Y{year}.npz  : test-set predictions
- joint_mtl_F2_L30/joint_mtl_report_Y{year}.pkl  : per-window metadata
"""
...
#   epoch   1: val_loss=3.613080e-04
#   epoch   2: val_loss=3.597294e-04
#   epoch   3: val_loss=3.578968e-04
#   epoch   4: val_loss=3.590708e-04
#   epoch   5: val_loss=3.556497e-04
#   epoch   6: val_loss=3.559265e-04
#   epoch   7: val_loss=3.553265e-04
#   epoch   8: val_loss=3.556270e-04
#   epoch   9: val_loss=3.559828e-04
#   epoch  10: val_loss=3.550518e-04
#   epoch  11: val_loss=3.554161e-04
#   epoch  12: val_loss=3.560155e-04
#   epoch  13: val_loss=3.558659e-04
#   epoch  14: val_loss=3.557858e-04
#   epoch  15: val_loss=3.562916e-04
#   epoch  16: val_loss=3.558541e-04
#   epoch  17: val_loss=3.558544e-04
#   epoch  18: val_loss=3.549285e-04
#   epoch  19: val_loss=3.562499e-04
#   epoch  20: val_loss=3.552058e-04
#   epoch  21: val_loss=3.561523e-04
#   epoch  22: val_loss=3.555989e-04
#   epoch  23: val_loss=3.553868e-04
#   epoch  24: val_loss=3.561307e-04
#   epoch  25: val_loss=3.547931e-04
#   epoch  26: val_loss=3.557078e-04
#   epoch  27: val_loss=3.564158e-04
#   epoch  28: val_loss=3.551987e-04
#   epoch  29: val_loss=3.548723e-04
#   epoch  30: val_loss=3.551102e-04
# [2011] micro=0.000574332 macro=0.000574172 | 90.5 min | assets=117
# [2012] micro=0.000341803 macro=0.000340002 | 51.7 min | assets=120
# [2013] micro=0.00032267 macro=0.000322305 | 74.0 min | assets=123
# [2014] micro=0.000520581 macro=0.00052138 | 78.0 min | assets=129
# [2015] micro=0.000507611 macro=0.000507611 | 99.5 min | assets=126
# [2016] micro=0.000387415 macro=0.000385458 | 125.3 min | assets=129
# [2017] micro=0.000278009 macro=0.000279331 | 75.4 min | assets=130
# [2018] micro=0.000427647 macro=0.000445725 | 69.9 min | assets=130
# [2019] micro=0.000442066 macro=0.000443607 | 148.0 min | assets=129
# [2020] micro=0.000772094 macro=0.000820173 | 152.2 min | assets=128
# [2021] micro=0.000338827 macro=0.000338827 | 189.4 min | assets=126
# [2022] micro=0.000589172 macro=0.000588853 | 128.2 min | assets=126
# [2023] micro=0.000513589 macro=0.000529842 | 166.9 min | assets=123
# [2024] micro=0.00121392 macro=0.00121563 | 98.1 min | assets=119
# [2025] micro=0.000703679 macro=0.000699981 | 212.2 min | assets=118
#
# Saved: joint_mtl_F2_L30/joint_mtl_window_metrics.csv
# Avg micro MSE: 0.000528895
# Avg macro MSE: 0.000534193
# TOTAL runtime: 1759.4 min
# Outputs dir: /Users/benmulder/Documents/Dokumente/Python/joint_mtl_F2_L30