"""
F3 Evaluation - Separate Deep Models (CPU Parallel)
====================================================
Expanding-window evaluation with one CNN-Transformer model per asset,
trained and predicted in parallel across CPU workers.

Identical to the F2 separate-model script — F3 shares the same input
dimensions (N, 30, 10).  Only the dataset and evaluation config paths
differ.

Inputs
------
- evaluation_config_F3_L30.pkl : window definitions (train/val/test indices)
- dataset_F3_L30.npz          : feature matrix X (N, 30, 10), targets y, asset IDs

Outputs
-------
- sep_deep_F3_L30_cpupar/sep_deep_window_metrics.csv : per-window MSE summary
- sep_deep_F3_L30_cpupar/sep_deep_preds_Y{year}.npz  : test-set predictions
- sep_deep_F3_L30_cpupar/sep_deep_report_Y{year}.pkl  : per-window metadata
"""
...
OUT_DIR = Path("sep_deep_F3_L30_cpupar")
...
# Eval config: evaluation_config_F3_L30.pkl
# Dataset:     dataset_F3_L30.npz
#
# ================================================================================
...
#   epoch 01: val=8.134093959049e-04  (active_assets=117/117)
#   epoch 02: val=4.145960621111e-04  (active_assets=117/117)
#   epoch 03: val=3.905510735162e-04  (active_assets=117/117)
#   epoch 04: val=3.781484756918e-04  (active_assets=117/117)
#   epoch 05: val=3.848595393218e-04  (active_assets=117/117)
#   epoch 06: val=3.829146491468e-04  (active_assets=117/117)
#   epoch 07: val=3.936407558564e-04  (active_assets=117/117)
#   epoch 08: val=3.954699622399e-04  (active_assets=117/117)
#   epoch 09: val=3.958112308979e-04  (active_assets=117/117)
#   epoch 10: val=3.959453433665e-04  (active_assets=117/117)
#   epoch 11: val=4.121049324611e-04  (active_assets=117/117)
#   epoch 12: val=4.061562015799e-04  (active_assets=115/117)
#   epoch 13: val=4.123919815188e-04  (active_assets=110/117)
#   epoch 14: val=4.181091260061e-04  (active_assets=103/117)
#   epoch 15: val=4.035058617285e-04  (active_assets=94/117)
#   epoch 16: val=3.936224637655e-04  (active_assets=86/117)
#   epoch 17: val=4.019645232167e-04  (active_assets=72/117)
#   epoch 18: val=3.967987579208e-04  (active_assets=65/117)
#   epoch 19: val=4.018371221935e-04  (active_assets=56/117)
#   epoch 20: val=4.096329612861e-04  (active_assets=52/117)
#   epoch 21: val=4.129908584887e-04  (active_assets=40/117)
#   epoch 22: val=4.204261971943e-04  (active_assets=37/117)
#   epoch 23: val=4.104855069082e-04  (active_assets=36/117)
#   epoch 24: val=4.125978239028e-04  (active_assets=34/117)
#   epoch 25: val=4.050565130484e-04  (active_assets=34/117)
#   epoch 26: val=4.222285215627e-04  (active_assets=32/117)
#   epoch 27: val=4.142314311623e-04  (active_assets=24/117)
#   epoch 28: val=4.175654518523e-04  (active_assets=20/117)
#   epoch 29: val=4.156446126735e-04  (active_assets=18/117)
#   epoch 30: val=4.152429408815e-04  (active_assets=14/117)
# [2011] done in 10.1 min | micro=0.000579415  macro=0.00058153
# [2011] NOTE: Stored per-epoch curves in sep_deep_report_Y2011.pkl.
#
# [2012] done in 12.5 min | micro=0.000344489  macro=0.000342664
# [2013] done in 14.5 min | micro=0.000323944  macro=0.000323574
# [2014] done in 14.6 min | micro=0.000521641  macro=0.000522606
# [2015] done in 16.5 min | micro=0.000511859  macro=0.000511859
# [2016] done in 17.4 min | micro=0.000389429  macro=0.000387572
# [2017] done in 18.4 min | micro=0.000280593  macro=0.000282097
# [2018] done in 19.3 min | micro=0.00042665   macro=0.000445934
# [2019] done in 19.7 min | micro=0.000442307  macro=0.000453918
# [2020] done in 22.4 min | micro=0.000773151  macro=0.000832515
# [2021] done in 21.5 min | micro=0.000340304  macro=0.000340467
# [2022] done in 23.3 min | micro=0.000591918  macro=0.000600073
# [2023] done in 22.8 min | micro=0.000517217  macro=0.000536138
# [2024] done in 23.2 min | micro=0.00120949   macro=0.0012179
# [2025] done in 23.5 min | micro=0.000704973  macro=0.000721647
# [2025] NOTE: Stored per-epoch curves in sep_deep_report_Y2025.pkl.
#
# Saved: sep_deep_F3_L30_cpupar/sep_deep_window_metrics.csv
# Avg micro MSE: 0.000530492
# Avg macro MSE: 0.000540033
# Outputs dir: /Users/benmulder/Documents/Dokumente/Python/sep_deep_F3_L30_cpupar